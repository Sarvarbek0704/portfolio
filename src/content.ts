...
export const t = {
  ...
  infra: {
    stat1: { uz: "jonli loyiha", en: "live projects" },
    stat1v: { uz: "10", en: "10" },
    stat2: { uz: "o'z VPS'imda self-hosted", en: "self-hosted on my own VPS" },
    stat2v: { uz: "8", en: "8" },
    stat3: { uz: "real foydalanuvchili mahsulot", en: "products with real users" },
    stat3v: { uz: "3", en: "3" },
    note: {
      uz: "Docker · Nginx · PostgreSQL · Let's Encrypt HTTPS — hammasi o'zim deploy qilgan",
      en: "Docker · Nginx · PostgreSQL · Let's Encrypt HTTPS — all deployed by me",
    },
  },
  work: {
